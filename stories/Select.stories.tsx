...
export const NoData = () => {
  ...
  return (
    <Wrapper>
      <Select onChange={handleChange} defaultValue={1} placeholder="请选择">
      </Select>
      <br />

      <Select onChange={handleChange} defaultValue={1} placeholder="请选择" multiple>
      </Select>
...
export const Suffix = () => {
  ...
  return (
    <Wrapper>
      <Select onChange={handleChange} defaultValue={1} style={{ width: 250 }} suffix="天">
        {
          students.map(o =>
      ...
      <Select onChange={handleChange} defaultValue={1} style={{ width: 250 }} suffix="天" prefix="test">
        {
          students.map(o =>
            <Option value={o.id} label={o.name} key={o.id}></Option>
          )
      ...
      <Select onChange={handleChange} defaultValue={1} style={{ width: 250 }} suffix="天" prefix="test" disabled>
        {
          students.map(o =>
            <Option value={o.id} label={o.name} key={o.id}></Option>
          )
