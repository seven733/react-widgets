...
export const Doc: Story<CanvasProps> = (args) => {
  return (
    <Canvas {...args} >
      <Coordinate>
        <Axis series={['x']} />
...
export function DonutState() {
  // 复现bug：切换更多的数据，legend显示不全
  const data = boolean('more', false)
    ? pieData.concat([
      { "id": 20, "name": "四川汇宇制药有限公司1", "brandName": "汇昕", "amount": 753013.82000000, "ratio": 0.5429 },
      { "id": 21, "name": "Baxter Oncology GmbH2", "brandName": "维达莎", "amount": 633944.32000000, "ratio": 0.4571 },
      { "id": 22, "name": "正大天晴药业集团股份有限公司3", "brandName": "维首", "amount": 0, "ratio": 0 },
    ])
    : pieData
