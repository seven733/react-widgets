...
import { Table, ColumnType } from '../src'
...
export default { title: 'Table', decorators: [withKnobs], component: Simple }
...
HybridTableHead.storyName = 'Hybrid Head'

SelectTable.storyName = 'Selectable Table'

FilterTable.storyName = 'Filter Table'

ResizableTable.storyName = 'Resizable'

FixedColumnTable.storyName = 'Fixed Columns Table'
